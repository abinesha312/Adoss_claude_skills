...
## Experience Index (titles, companies, dates, locations — NEVER change)
...
## Default Projects Pool (select ≤4 JD-relevant — never list all)
...
- **vision-transformer-cifar** — Interpretable ViT on CIFAR-10 — github.com/abinesha312/vision-transformer-cifar
...
- **Job-Interview-Simulator** — Real-time NLP interview feedback — github.com/abinesha312/Job-Interview-Simulator-with-Real-time-Feedback

## Mandatory Sections (all 7 — fixed order)
...
| Section | Action |
| --- | --- |
| Summary | Rewrite first — sets narrative all bullets align with |
| Experience bullets | Match Summary + JD keywords; crisp single-line bullets |
| Internship bullets | Same as experience |
| Projects | ≤4 JD-relevant picks from pool only |
| Technical Skills | Reorder; add JD tools candidate actually uses |

### What NEVER to change

- Name, contact info, URLs
- Job titles, company names, employment dates, locations
- Section order and all 7 mandatory sections
- Fabricated experience — reframe real work only; never invent employers or metrics
- **Bold only numeric metrics** in body bullets (e.g., 85%, 99.9%) — not tool names or keywords
