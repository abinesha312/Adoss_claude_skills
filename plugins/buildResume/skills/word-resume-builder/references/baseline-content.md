# Baseline Word Content

Structured starting text for every tailoring request. **Modify Summary, Experience/Internship bullets, Projects (≤4 from pool), and Technical Skills.** Preserve titles, companies, dates, locations, and section order.
...
## Projects (replace with ≤4 JD-relevant from pool)
